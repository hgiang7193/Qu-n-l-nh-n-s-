    ...
    public class DatabaseInitializer
    {
        ...
        private async Task PopulateDatabaseWithSampleData()
        {
            ...
            try
            {
                ...
                await _context.Database.ExecuteSqlRawAsync("UPDATE Departments SET ManagerId = NULL;");
                await _context.Database.ExecuteSqlRawAsync("UPDATE Projects SET ProjectManagerId = NULL;");
